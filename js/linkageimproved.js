...
// --- Version 3.8.2: Visible Highlight Fix with Added Cleanup ---
// Changes from v3.8.1:
// 1. Added call to clearAllHighlights() in performBlockSnap() after playSnapSound
//    to ensure points disappear immediately after connecting blocks.
...
(function() {
  ...
  // ========================================================================
  // ביצוע ההצמדה הפיזית - חיבור פאזל מדויק - עם תיקון לניקוי
  // ========================================================================
  function performBlockSnap(sourceBlock, targetBlock, direction) {
    ...
    try {
      ...
      // Play sound on successful snap
      playSnapSound(); 
      
      // Add visual effect to block
      addSnapEffectAnimation(sourceBlock);
      
      // Clean up all highlights after successful connection
      clearAllHighlights();
