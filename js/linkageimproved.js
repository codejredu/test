        ...
        function connectBlocks(sourceBlock, targetBlock) {
            ...
            try {
                ...
                if (sourceCenterX < targetCenterX) {
                    ...
                    // בדיקה אם קרוב מספיק להצמדה
                    if (Math.abs(newLeft - sourceRect.left) <= CONNECTION_TOLERANCE &&
                        Math.abs(newTop - sourceRect.top) <= CONNECTION_TOLERANCE) {
                        console.log('מחבר משמאל לימין, מיקום חדש:', newLeft, newTop);
                    } else {
                        console.log('לא קרוב מספיק להצמדה משמאל לימין');
                        return; // אל תבצע את החיבור
                    }
                    ...
                    if (Math.abs(newLeft - sourceRect.left) <= CONNECTION_TOLERANCE &&
                        ...
                        console.log('לא קרוב מספיק להצמדה מימין לשמאל');
                        return; // אל תבצע את החיבור
                    }
                }
