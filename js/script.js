...
// ========================================================================
// Background Button Setup (NEW SECTION)
// ========================================================================
const backgroundButton = document.getElementById("background-button");
// const stage = document.getElementById("stage"); // Already defined

if (backgroundButton && stage) {
    backgroundButton.addEventListener("click", () => {
        // פה תוכל להוסיף קוד לפתיחת חלון בחירת רקע או החלפת רקע ישירות
        // לדוגמה, אפשר להחליף את קלאס הרקע של הבמה
        stage.classList.toggle('change-background'); // Toggle a class to change background
    });
}
...
#stage.change-background {
    background-color: #e0f7fa; /* דוגמה: צבע רקע תכלת בהיר */
    /* או לחלופין, תמונה:
    background-image: url('assets/images/stage-background.png');
