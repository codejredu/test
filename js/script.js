...
function handleCategoryChange(category, tabElement) {
    ...
    categoryBlocksElement.style.left = `${blockPaletteRect.left}px`; // Position category to the right of the **palette**
    categoryBlocksElement.style.top = `${blockPaletteRect.bottom}px`;   // **Position BELOW the tabs**
}
